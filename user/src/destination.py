...
class destinationPage(QWidget):
    ...
    def init_ui(self):
        self.setWindowTitle("destination Page")
        layout = QVBoxLayout()
        self.label = QLabel(f"destinationl Page - Departure: {self.saved_data.get('departure')}, Destination: {self.saved_data.get('destination')}")
