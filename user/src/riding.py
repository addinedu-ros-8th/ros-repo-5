...
class ridingPage(QWidget):
    ...
    def init_ui(self):
        self.setWindowTitle("riding Page")
        layout = QVBoxLayout()
        self.label = QLabel(f"riding Page - Departure: {self.saved_data.get('departure')}, Destination: {self.saved_data.get('destination')}")
